...
import { TrendingUp, TrendingDown, DollarSign, Globe, Activity, BarChart3, Eye, Zap } from 'lucide-react';
            ...
            {data.fearGreed ? (
              <div className="space-y-4">
                <div className="text-center">
                  <div className={`text-4xl font-bold ${getFearGreedTextColor(data.fearGreed.value)}`}>
                    {data.fearGreed.value}
                  </div>
                  <div className="text-sm font-medium text-muted-foreground">
                    {data.fearGreed.value_classification}
                  </div>
                </div>
                <div className="space-y-2">
                  <Progress 
              ...
              <div className="space-y-3">
                <div>
                  <div className="text-2xl font-bold">
                    {formatCurrency(data.globalMarket.total_market_cap)}
                  </div>
                  <div className="text-sm text-muted-foreground">Total Market Cap</div>
                </div>
                <div className="flex items-center gap-2">
                  <Badge 
                    variant={data.globalMarket.market_cap_change_24h >= 0 ? "default" : "destructive"}
                    className="text-xs"
                  >
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-bold text-orange-600">
                    {data.globalMarket.btc_dominance.toFixed(1)}%
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">Ethereum</span>
                  <span className="text-lg font-bold text-blue-600">
                    {data.globalMarket.eth_dominance.toFixed(1)}%
                  </span>
                </div>
